      ...
      <div className="mx-auto grid grid-cols-1 lg:grid-cols-[25%_30%_45%]">
        ...
        <div className="flex items-center justify-center px-10 py-10 text-center">
          <div className="max-w-md">
            ...
            <h2 className="mb-6 text-3xl font-light leading-snug tracking-wider text-gray-700 md:text-4xl uppercase relative inline-block">
            ...
            <p className="text-gray-600 leading-relaxed text-[15px] md:text-[16px] mb-10">
