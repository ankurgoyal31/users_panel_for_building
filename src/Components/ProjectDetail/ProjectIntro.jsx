...
import img from "../../assets/img/gm-logo.png";
  ...
  return (
    <section className="w-full  mx-auto px-6 py-16 text-center">
      ...
      <h4 className=" text-lg font-medium mb-6" style={{letterSpacing:"0.7px"}}>
       200-ft Main Tonk Road, Shivdaspura / Choki Dhani area, Jaipur
      </h4>

      {/* Main Description */}
      <p className="text-gray-700 px-100 text-sm leading-relaxed max-w-7xl mx-auto" style={{letterSpacing: "0.4px"}}>
   Find peaceful living in Jaipur’s luxury high-rise, where every planned 1,2 & 3 BHK homes fuse comfort, style, and elevated views to create a perfect premium experience every day. 
