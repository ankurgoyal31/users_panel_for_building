...
import img1 from "../../assets/img/clubpool.jpg"; 
import img2 from "../../assets/img/Grass.jpg"; 
import img3 from "../../assets/img/kidsarea.jpg"; 
import img4 from "../../assets/img/kids.jpg"; 
...
export default function LuxuryTabs() {
  ...
  return (
    <div className="w-full mx-auto py-20 px-28">
